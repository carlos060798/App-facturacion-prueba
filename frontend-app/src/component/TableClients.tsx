...
import { getClientes } from '../api/clienteApi'; // Asegúrate de tener esta función en tu API
import { Cliente } from '../interface/Cliente-interface';

function ClientesTable() {
  // Obtener los clientes usando useQuery
  const { data: clientes, isLoading, isError } = useQuery({
    queryKey: ['clientes'],
    queryFn: getClientes,
    retry: false, // Puedes ajustar según tus necesidades
